...
$page_title = 'View the User Handles';
...
// Define the query:
$q = "SELECT username, first_name, last_name FROM users";
$r = @mysqli_query($dbc, $q);
...
<thead>
<tr>
	<th align="left"><strong>User Handles</strong></th
	<th align="right"><strong>User Names</strong></th>
</tr>
</thead>
<tbody>
';
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
	...
	echo '<tr bgcolor="' . $bg . '">
		...
		<td align="left">' . $row['last_name'],['first_name'] . '</td>
	</tr>
	';
